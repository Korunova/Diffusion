# -*- coding: utf-8 -*-
"""
The script works with outputs generated by 'Deff_calculation.py' or 'Deff_calculation_direct_dynamic_error.py', including Deff distribution, 
to estimate Spearman and Pearson correlation coefficients for the dependency of parameters on fluorescent intensity, which is collected separately using Fiji.
"""
