...
time- and ensemble averaged MSD calculated from tracks estimated by Mosaic Suite
...
tau = 0.01 #time displacement for MSD calculation, interpolation
save = False
...
for experiment in experiments: 
    ...
    norm = plt.Normalize(vmin=min(combined_color), vmax=0.15)  # Normalize to the range of combined_color
    ...
    result = FitLinearFunction(name, time_data_log10[0:limit], msd_data_log10[0:limit], exp_cond[condition], n = color_number, points = 10, sigma = msd_std_data_log10[0:limit], check_plot = False)
